...
<style>
    .stApp {
        background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkUvhi-mYdaquhn2WlKlHKiP6VEQQ0izxhKg&s");
...
def create_dashboard(df):
    ...
    avg_reading.plot(kind='bar', figsize=(8,4), edgecolor='black')
    
    
    sns.barplot(x="test_preparation_course", y="reading_score", data=df, ax=ax) 
